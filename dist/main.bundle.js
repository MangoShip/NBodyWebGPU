...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "simParams": () => (/* binding */ simParams)
/* harmony export */ });
...
const [contextIsConfigured, setContextIsConfigured] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
...
// Delte canvas context for redrawing canvas
jquery__WEBPACK_IMPORTED_MODULE_2___default()('#updateButton').on('click', () => {
    var canvasCPU = document.getElementById('canvasCPU');
    var context = canvasCPU.getContext("2d");
    console.log("CanvasCPU Clear");
    setContextIsConfigured(false);
    context.clearRect(0, 0, canvasCPU.width, canvasCPU.height);
});
